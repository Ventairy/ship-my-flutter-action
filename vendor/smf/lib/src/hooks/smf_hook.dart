...
import '../dtos/changelog_release.dart';
import '../dtos/release_plan.dart';
import '../error.dart';
...
Future<SmfHookContext> _readContext(String path) async {
  try {
    ...
    throw SmfError(
      'The SMF hook context is invalid: $error',
...
String _requiredEnvironment(Map<String, String> environment, String name) {
  ...
  if (value == null || value.isEmpty) {
    throw SmfError(
      '$name is required when running an SMF hook.',
      'HOOK_ENVIRONMENT_MISSING',
    );
  }
  return value;
}
