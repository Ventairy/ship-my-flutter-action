...
mixin _$AndroidConfig {
 ...
 bool get enabled; String get initialVersion; String? get packageName; String? get buildCommand; String get aabOutputPath; GooglePlayConfig get googlePlay;
...
@override
int get hashCode => Object.hash(runtimeType,enabled,initialVersion,packageName,buildCommand,aabOutputPath,googlePlay);

@override
String toString() {
  return 'AndroidConfig(enabled: $enabled, initialVersion: $initialVersion, packageName: $packageName, buildCommand: $buildCommand, aabOutputPath: $aabOutputPath, googlePlay: $googlePlay)';
}
...
@useResult
$Res call({
 bool enabled, String initialVersion, String? packageName, String? buildCommand, String aabOutputPath, GooglePlayConfig googlePlay
});
...
/// Create a copy of AndroidConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? enabled = null,Object? initialVersion = null,Object? packageName = freezed,Object? buildCommand = freezed,Object? aabOutputPath = null,Object? googlePlay = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool enabled,  String initialVersion,  String? packageName,  String? buildCommand,  String aabOutputPath,  GooglePlayConfig googlePlay)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AndroidConfig() when $default != null:
return $default(_that.enabled,_that.initialVersion,_that.packageName,_that.buildCommand,_that.aabOutputPath,_that.googlePlay);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool enabled,  String initialVersion,  String? packageName,  String? buildCommand,  String aabOutputPath,  GooglePlayConfig googlePlay)  $default,) {final _that = this;
switch (_that) {
case _AndroidConfig():
return $default(_that.enabled,_that.initialVersion,_that.packageName,_that.buildCommand,_that.aabOutputPath,_that.googlePlay);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool enabled,  String initialVersion,  String? packageName,  String? buildCommand,  String aabOutputPath,  GooglePlayConfig googlePlay)?  $default,) {final _that = this;
switch (_that) {
case _AndroidConfig() when $default != null:
return $default(_that.enabled,_that.initialVersion,_that.packageName,_that.buildCommand,_that.aabOutputPath,_that.googlePlay);case _:
  return null;
...
class _AndroidConfig implements AndroidConfig {
  const _AndroidConfig({this.enabled = false, this.initialVersion = '0.0.0', this.packageName, this.buildCommand, this.aabOutputPath = 'build/app/outputs/bundle/release', this.googlePlay = const GooglePlayConfig()});
...
/// Create a copy of AndroidConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? enabled = null,Object? initialVersion = null,Object? packageName = freezed,Object? buildCommand = freezed,Object? aabOutputPath = null,Object? googlePlay = null,}) {
