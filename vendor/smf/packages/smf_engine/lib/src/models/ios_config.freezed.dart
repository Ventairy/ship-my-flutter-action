...
mixin _$IosConfig {
 ...
 bool get enabled; String get initialVersion; String? get bundleId; String? get buildCommand; String get ipaOutputPath; AppStoreConfig get appStore;
...
@override
int get hashCode => Object.hash(runtimeType,enabled,initialVersion,bundleId,buildCommand,ipaOutputPath,appStore);

@override
String toString() {
  return 'IosConfig(enabled: $enabled, initialVersion: $initialVersion, bundleId: $bundleId, buildCommand: $buildCommand, ipaOutputPath: $ipaOutputPath, appStore: $appStore)';
}
...
@useResult
$Res call({
 bool enabled, String initialVersion, String? bundleId, String? buildCommand, String ipaOutputPath, AppStoreConfig appStore
});
...
/// Create a copy of IosConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? enabled = null,Object? initialVersion = null,Object? bundleId = freezed,Object? buildCommand = freezed,Object? ipaOutputPath = null,Object? appStore = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool enabled,  String initialVersion,  String? bundleId,  String? buildCommand,  String ipaOutputPath,  AppStoreConfig appStore)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IosConfig() when $default != null:
return $default(_that.enabled,_that.initialVersion,_that.bundleId,_that.buildCommand,_that.ipaOutputPath,_that.appStore);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool enabled,  String initialVersion,  String? bundleId,  String? buildCommand,  String ipaOutputPath,  AppStoreConfig appStore)  $default,) {final _that = this;
switch (_that) {
case _IosConfig():
return $default(_that.enabled,_that.initialVersion,_that.bundleId,_that.buildCommand,_that.ipaOutputPath,_that.appStore);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool enabled,  String initialVersion,  String? bundleId,  String? buildCommand,  String ipaOutputPath,  AppStoreConfig appStore)?  $default,) {final _that = this;
switch (_that) {
case _IosConfig() when $default != null:
return $default(_that.enabled,_that.initialVersion,_that.bundleId,_that.buildCommand,_that.ipaOutputPath,_that.appStore);case _:
  return null;
...
class _IosConfig implements IosConfig {
  const _IosConfig({this.enabled = true, this.initialVersion = '0.0.0', this.bundleId, this.buildCommand, this.ipaOutputPath = 'build/ios/ipa', this.appStore = const AppStoreConfig()});
...
/// Create a copy of IosConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? enabled = null,Object? initialVersion = null,Object? bundleId = freezed,Object? buildCommand = freezed,Object? ipaOutputPath = null,Object? appStore = null,}) {
