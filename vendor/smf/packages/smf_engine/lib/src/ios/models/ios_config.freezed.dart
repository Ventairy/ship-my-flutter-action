...
mixin _$IosConfig {
 ...
 bool get isEnabled; String get initialVersion; String? get bundleId; String? get buildCommand; String get ipaOutputPath; AppStoreConfig get appStore;
...
@override
int get hashCode => Object.hash(runtimeType,isEnabled,initialVersion,bundleId,buildCommand,ipaOutputPath,appStore);

@override
String toString() {
  return 'IosConfig(isEnabled: $isEnabled, initialVersion: $initialVersion, bundleId: $bundleId, buildCommand: $buildCommand, ipaOutputPath: $ipaOutputPath, appStore: $appStore)';
}
...
@useResult
$Res call({
 bool isEnabled, String initialVersion, String? bundleId, String? buildCommand, String ipaOutputPath, AppStoreConfig appStore
});
...
/// Create a copy of IosConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isEnabled = null,Object? initialVersion = null,Object? bundleId = freezed,Object? buildCommand = freezed,Object? ipaOutputPath = null,Object? appStore = null,}) {
...
as String,appStore: null == appStore ? _self.appStore : appStore // ignore: cast_nullable_to_non_nullable
as AppStoreConfig,
  ));
}
/// Create a copy of IosConfig
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isEnabled,  String initialVersion,  String? bundleId,  String? buildCommand,  String ipaOutputPath,  AppStoreConfig appStore)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IosConfig() when $default != null:
return $default(_that.isEnabled,_that.initialVersion,_that.bundleId,_that.buildCommand,_that.ipaOutputPath,_that.appStore);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isEnabled,  String initialVersion,  String? bundleId,  String? buildCommand,  String ipaOutputPath,  AppStoreConfig appStore)  $default,) {final _that = this;
switch (_that) {
case _IosConfig():
return $default(_that.isEnabled,_that.initialVersion,_that.bundleId,_that.buildCommand,_that.ipaOutputPath,_that.appStore);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isEnabled,  String initialVersion,  String? bundleId,  String? buildCommand,  String ipaOutputPath,  AppStoreConfig appStore)?  $default,) {final _that = this;
switch (_that) {
case _IosConfig() when $default != null:
return $default(_that.isEnabled,_that.initialVersion,_that.bundleId,_that.buildCommand,_that.ipaOutputPath,_that.appStore);case _:
  return null;
...
class _IosConfig implements IosConfig {
  const _IosConfig({this.isEnabled = true, this.initialVersion = '0.0.0', this.bundleId, this.buildCommand, this.ipaOutputPath = 'build/ios/ipa', this.appStore = const AppStoreConfig()});
...
@override $AppStoreConfigCopyWith<$Res> get appStore;
...
/// Create a copy of IosConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isEnabled = null,Object? initialVersion = null,Object? bundleId = freezed,Object? buildCommand = freezed,Object? ipaOutputPath = null,Object? appStore = null,}) {
