...
_AppStoreVersionAttributesDto _$AppStoreVersionAttributesDtoFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('_AppStoreVersionAttributesDto', json, ($checkedConvert) {
  final val = _AppStoreVersionAttributesDto(
...
Map<String, dynamic> _$AppStoreVersionAttributesDtoToJson(
  _AppStoreVersionAttributesDto instance,
) => <String, dynamic>{
